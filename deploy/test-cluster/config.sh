...
# automation range: vmid 2090-2091, IPs .96-.97.
set -euo pipefail

# --- test cluster hosts (see deploy/terragrunt/rknode/terragrunt.hcl) ---
export RK_MASTER_IP="192.168.8.96"
export RK_MASTER_FQDN="rkmaster1.g8.lo"
export RK_NODE_IP="192.168.8.97"
export RK_NODE_FQDN="rknode1.g8.lo"
export CI_USER="fedora"

# --- pinned released artifacts (reproducible; no build on the VMs) ---
# rustkube control plane (kube-apiserver/controller/scheduler).
export RUSTKUBE_RPM="https://github.com/glennswest/rustkube/releases/download/v0.6.0/kubernetes-rs-0.6.0-1.x86_64.rpm"
